...
여러 줄 값을 입력하는 Textarea 컴포넌트입니다. `component/index.html`의 Forms 영역에서 전체 상태를 확인합니다.

- 필수 CSS: `component/_shared/form-control.css`, `component/textarea/textarea.css`
...
<div class="field" data-character-count>
    ...
    <textarea class="form-textarea" id="operationMemo" name="operationMemo" rows="4"
        maxlength="200" aria-describedby="operationMemoHelp operationMemoCount"></textarea>

...
기존 화면의 `form-select`를 그대로 사용하는 Select 컴포넌트입니다. `component/index.html`의 Forms 영역에서 전체 상태를 확인합니다.

- 필수 CSS: `component/_shared/form-control.css`, `component/select/select.css`
- 필수 JS: 없음

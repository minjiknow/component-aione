...
끝.`;
    ...
    const docMetaMap = {
        ...
        "김민수의원_추가질의_재정건전성.pdf": {
            ...
            date: "2026.03.20",
            recipient: "재정경제부 장관",
            title: "재정건전성 관련 추가 질의",
            intro: ["1. 지난 상임위 질의에 대한 답변에 감사드립니다.", "2. 아래 사항에 대해 추가 답변이 필요하여 다시 질의드립니다."],
            closing: "상기 사항에 대해 2026년 3월 27일까지 회신하여 주시기 바랍니다.",
            signer: "국회의원 김민수",
            committee: "기획재정위원회",
            memberName: "김민수 (인)",
            partyName: "국회",
        ...
        "국정감사_의원질의_경제정책.txt": {
            dept: "국회 기획재정위원회 국정감사",
            docType: "국정감사 질의서",
            docNo: "국감-2026-0056",
            date: "2026.10.10",
            recipient: "재정경제부 장관",
            title: "경제정책 분야 국정감사 질의",
            intro: ["1. 2026년도 국정감사에 임하여 아래와 같이 질의합니다.", "2. 성실한 답변을 요청드립니다."],
            closing: "상기 사항에 대해 국정감사 종료 전까지 서면답변을 제출하여 주시기 바랍니다.",
            signer: "국회 기획재정위원회",
            committee: "기획재정위원회",
            memberName: "국정감사 위원",
            partyName: "국회",
            ...
            queries: [
                {
                    id: 1,
                    text: "2026년도 예산편성지침 중 인건비 산정기준 변경사항에 대한 구체적 안내 요청",
                    summary: "2026년도 예산편성지침에서 인건비 산정기준 변경 내용과 적용 방법에 대한 구체적 안내 요청",
                    type: "single",
                    typeLabel: "단일소관",
                    mainDept: "경제정책국",
                    coopDept: "",
                ...
                },
                {
                    id: 2,
                    text: "지방자치단체 재정자립도 산정 시 세외수입 항목 포함 여부 및 관련 법령 해석",
                    summary: "지방재정법상 재정자립도 산정 기준에 세외수입을 포함해야 하는지에 대한 법령 해석 질의",
                    type: "multi",
                    typeLabel: "복수소관",
                    mainDept: "경제정책국",
                    coopDept: "세제실",
                    org: "행정안전부",
                    confidence: 82,
                    keywords: ["재정자립도", "세외수입", "법령"],
                    conflict: { ruleDept: "세제실", aiDept: "경제정책국", ruleLabel: "세제 키워드 룰" },
                },
                {
                    id: 3,
                    text: "공공기관 경영평가 시 비계량지표 평가방법론 개선 관련 의견 조회",
                    summary: "공공기관 경영평가의 비계량지표 평가방법을 개선하기 위한 방안에 대한 의견 조회",
                    type: "single",
                    typeLabel: "단일소관",
                    mainDept: "공공정책국",
                    coopDept: "",
                    org: "재정경제부",
                    confidence: 91,
                    keywords: ["공공기관", "경영평가", "비계량지표"],
                },
                {
                    id: 4,
                    text: "외국환거래법 개정에 따른 해외직접투자 신고절차 변경 안내 요청",
                    summary: "외국환거래법 개정(2026.3.1. 시행)에 따라 변경된 해외직접투자 신고절차에 대한 안내 요청",
                    type: "multi",
                    typeLabel: "복수소관",
                    mainDept: "국제금융국",
                    coopDept: "대외경제국",
                    org: "한국은행",
                    confidence: 78,
                    keywords: ["외국환거래법", "해외직접투자"],
                    conflict: { ruleDept: "국제금융국", aiDept: "경제정책국", ruleLabel: "외환거래 룰" },
                },
                {
                    id: 5,
                    text: "최근 기상이변으로 인한 농작물 피해 현황 자료 요청의 건",
                    summary: "최근 기상이변으로 발생한 농작물 피해 현황 자료를 요청하는 질의로 농림축산식품부 소관 사항",
                    type: "none",
                    typeLabel: "비소관",
                    mainDept: "해당없음",
                    coopDept: "",
...
끝.`,
            queries: [
                {
                    id: 6,
                    text: "2026년 종합부동산세 세율 조정에 따른 세수 영향 추정치 및 1세대 1주택자 특례 적용 시나리오별 세수 변동 규모 요청",
                    summary: "종합부동산세 세율 조정 시나리오별 세수 영향과 1세대 1주택자 특례 적용에 따른 세수 변동 규모 추정치를 요청하는 질의",
                    type: "single",
                    typeLabel: "단일소관",
                    mainDept: "세제실",
                    coopDept: "",
                    org: "재정경제부",
                    confidence: 92,
                    keywords: ["종합부동산세", "세율 조정"],
                },
                {
                    id: 7,
                    text: "간이과세자 기준금액 상향 조정에 따른 부가가치세 세수 감소 규모 및 행정비용 변화 분석 요청",
                    summary: "간이과세자 기준금액 상향 조정이 부가가치세 세수와 과세유형 전환 행정비용에 미치는 영향을 분석해 달라는 질의",
                    type: "single",
                    typeLabel: "단일소관",
                    mainDept: "세제실",
                    coopDept: "",
                    org: "국세청",
                    confidence: 88,
                    keywords: ["간이과세자", "부가가치세"],
                },
                {
                    id: 8,
                    text: "법인세 최저한세율 적용 대상 확대 방안 및 중소기업 예외 적용 필요성 검토 의견 조회",
                    summary: "법인세 최저한세율 적용 대상을 확대할 경우 중소기업에 대한 예외 적용이 필요한지에 대한 검토 의견 조회",
                    type: "multi",
                    typeLabel: "복수소관",
                    mainDept: "세제실",
                    coopDept: "경제구조개혁국",
...
3. 관리재정수지 적자 확대에 대한 구조적 원인 분석과 향후 개선 방안을 질의합니다. 경기순환적 요인과 구조적 요인을 구분하여 설명해 주시기 바랍니다.`,
            queries: [
                {
                    id: 9,
                    text: "GDP 대비 국가채무비율 전망치 및 중장기 관리목표 달성 가능성을 포함한 국가채무 관리 계획 실효성 질의",
                    summary: "2026년 말 기준 국가채무비율 전망과 중장기 관리계획의 실효성 및 목표 달성 가능성에 대한 질의",
                    type: "multi",
                    typeLabel: "복수소관",
                    mainDept: "국고실",
                    coopDept: "경제정책국",
                ...
                {
                    id: 10,
                    text: "추가경정예산 편성 없이 세입경정으로 대응 가능한지를 포함한 2026년 세수 결손 규모 및 대응 계획 답변 요구",
                    summary: "2026년 세수 결손 규모와 세입경정을 통한 대응 가능성 등 정부의 구체적 대응 계획을 요구하는 질의",
                    type: "multi",
                    typeLabel: "복수소관",
                    mainDept: "세제실",
                    coopDept: "경제정책국",
                ...
                {
                    id: 11,
                    text: "경기순환적 요인과 구조적 요인을 구분한 관리재정수지 적자 확대 원인 분석 및 개선 방안 질의",
                    summary: "관리재정수지 적자 확대의 원인을 경기순환적 요인과 구조적 요인으로 구분하여 분석하고 개선 방안을 요구하는 질의",
                    type: "multi",
                    typeLabel: "복수소관",
                    mainDept: "국고실",
                    coopDept: "경제정책국",
...
4. 최근 3년간 세수 추계 오차율 및 개선 방안을 요구합니다. 오차 발생의 구조적 원인과 향후 추계 모델 개선 계획을 포함해 주시기 바랍니다.`,
            queries: [
                {
                    id: 12,
                    text: "전년 동월 대비 증감률을 포함한 2026년 월별 세수 실적 및 진도율 현황표 제출 요구",
                    summary: "2026년 월별 세수 실적과 진도율을 전년 동월 대비 증감률과 함께 제출해 달라는 요구",
                    type: "single",
                    typeLabel: "단일소관",
                    mainDept: "세제실",
                    coopDept: "",
                ...
                {
                    id: 13,
                    text: "세목별 결손 기여도를 정량적으로 제시한 주요 세목별 결손 원인 분석 자료 요구",
                    summary: "소득세·법인세·부가가치세 등 주요 세목별 결손 원인과 기여도를 정량적으로 분석해 달라는 요구",
                    type: "single",
                    typeLabel: "단일소관",
                    mainDept: "세제실",
                    coopDept: "",
                ...
                {
                    id: 14,
                    text: "편성 시 예상 규모와 재원 조달 방안을 포함한 추가경정예산 편성 검토 여부 입장 질의",
                    summary: "세수 결손 보전을 위한 추가경정예산 편성 여부와 편성 시 예상 규모·재원 조달 방안에 대한 입장 질의",
                    type: "multi",
                    typeLabel: "복수소관",
                    mainDept: "경제정책국",
                    coopDept: "국고실, 세제실",
                    org: "재정경제부",
                    confidence: 86,
                    keywords: ["추가경정예산", "재원 조달"],
                },
                {
                    id: 15,
                    text: "오차 발생의 구조적 원인과 개선 계획을 포함한 최근 3년간 세수 추계 오차율 및 개선 방안 요구",
                    summary: "최근 3년간 세수 추계 오차율의 구조적 원인을 분석하고 향후 추계 모델 개선 방안을 요구하는 질의",
                    type: "single",
                    typeLabel: "단일소관",
                    mainDept: "세제실",
                    coopDept: "",
...
[질의3] 청년 일자리 대책 중 재정사업의 실질적 성과와 개선 필요사항을 질의합니다. 사업별 고용창출 효과를 구체적 수치로 제시해 주시기 바랍니다.`,
            queries: [
                {
                    id: 16,
                    text: "대책별 집행률과 향후 추진 일정을 포함한 하반기 경제정책방향 민생안정 대책 이행 현황 보고 요구",
                    summary: "하반기 경제정책방향의 민생안정 대책에 대한 집행률과 이행 현황, 향후 추진 일정을 보고하라는 요구",
                    type: "multi",
                    typeLabel: "복수소관",
                    mainDept: "민생경제국",
                    coopDept: "경제정책국",
                ...
                {
                    id: 17,
                    text: "최근 금리정책 방향과의 연계성을 포함한 물가안정 목표 달성 위한 정부·한은 정책 공조 현황 질의",
                    summary: "물가안정 목표 달성을 위한 정부와 한국은행의 정책 공조 현황과 금리정책 연계성에 대한 질의",
                    type: "multi",
                    typeLabel: "복수소관",
                    mainDept: "민생경제국",
                    coopDept: "경제정책국",
                ...
                {
                    id: 18,
                    text: "사업별 고용창출 효과를 포함한 청년 일자리 재정사업 성과 및 개선 필요사항 질의",
                    summary: "청년 일자리 재정사업의 사업별 고용창출 효과와 성과, 개선이 필요한 사항에 대한 질의",
                    type: "multi",
                    typeLabel: "복수소관",
                    mainDept: "경제구조개혁국",
                    coopDept: "민생경제국",
    ...
    const sessions = [
        {
            id: 1,
            title: "재경위_제437회국회(임시회) 제1차 전체회의",
            status: "done",
            time: "14:23",
            date: "2026.07.21",
        ...
        {
            id: 2,
            title: "재경위_제429회국회(정기회) 제7차 전체회의",
            status: "done",
            time: "10:45",
            date: "2026.07.18",
        ...
        {
            id: 3,
            title: "예결위_제437회국회(임시회) 제1차 전체회의",
            status: "done",
            time: "16:30",
            date: "2026.07.16",
        ...
        {
            id: 4,
            title: "예결위_제429회국회(정기회) 제7차 전체회의",
            status: "pending",
            time: "09:15",
            date: "2026.07.14",
    ...
    const notificationOrganizationOrder = ["부총리 직속", "제1차관 직속", "제1차관 소관", "제1차관 추진단", "제2차관 직속", "제2차관 소관"];
    ...
    const notificationDepartmentDirectory = [
        ...
        { organization: "제1차관 소관", dept: "경제구조개혁국", subunits: ["경제구조개혁총괄과", "경제구조분석과", "노동시장경제과", "연금보건경제과", "청년정책과"], staff: createNotificationStaff("경제구조개혁국", 30) },
        {
            ...
            staff: createNotificationStaff("혁신성장실", 33),
        },
        {
            organization: "제1차관 소관",
            dept: "세제실",
            ...
            staff: createNotificationStaff("세제실", 36),
        },
        ...
        {
            organization: "제2차관 소관",
            dept: "기획조정실",
            subunits: ["정책기획관", "기획재정담당관", "혁신정책담당관", "규제개혁법무담당관", "정보화담당관", "비상안전기획관", "비상안전기획팀"],
            staff: createNotificationStaff("기획조정실", 57),
        },
        {
            organization: "제2차관 소관",
            dept: "국고실",
            ...
            staff: createNotificationStaff("국고실", 60),
        },
        ...
        { organization: "제2차관 소관", dept: "개발금융국", subunits: ["개발금융총괄과", "국제기구과", "개발전략과", "개발사업협력과", "개발정책협력과", "녹색기후기획과"], staff: createNotificationStaff("개발금융국", 72) },
        {
            organization: "제2차관 소관",
            dept: "공공정책국",
            subunits: ["공공혁신심의관", "공공정책총괄과", "공공제도기획과", "재무경영과", "평가분석과", "인재경영과", "공공윤리정책과", "공공혁신기획과", "경영관리과"],
            staff: createNotificationStaff("공공정책국", 75),
        },
    ];
    ...
    function init() {
        ...
        const uploadSortSelect = $("#uploadSortSelect");
        if (uploadSortSelect) {
            uploadSortSelect.value = uploadSortOrder;
            uploadSortSelect.addEventListener("change", () => {
                uploadSortOrder = uploadSortSelect.value === "oldest" ? "oldest" : "latest";
                renderFileList();
            });
        }
    ...
    function bindEvents() {
        ...
        uploadZone.addEventListener("app:file-upload", (event) => {
            validateFilesBeforeUpload(event.detail.files, addFiles);
        });

        const queryFilterBar = $(".panel-right .filter-bar");
        queryFilterBar?.addEventListener("filter-btn:change", (event) => {
        ...
        $$(".nav-link", sidebar).forEach((link) => {
            link.addEventListener("click", () => {
                if (link.dataset.page === "home" || link.dataset.soonTarget) return;
                localStorage.setItem("sidebar-collapsed", "true");
        ...
        if (newClassifyBtn)
            newClassifyBtn.addEventListener("click", () => {
    ...
    function saveWorkspaceMeta() {
        try {
            localStorage.setItem(WORKSPACE_META_KEY, JSON.stringify({ title: workspaceTitle, memberCount: workspaceMemberCount }));
        } catch (error) {}
    ...
    function bindWorkspaceMetaControls() {
        ...
        const openEdit = () => {
            ...
            if (titleInput) {
                titleInput.value = workspaceTitle || "제목없는 국회질의";
                titleInput.focus();
                titleInput.select();
            }
        };
    ...
    function loadSampleData() {
        ...
        ].map((file, index) => ({ ...file, uploadOrder: index + 1 }));
        uploadSequence = uploadedFiles.length;
        activeFileIndex = 0;
        renderFileList();
    ...
    function getDocOriginalWidthBounds(splitView, handleWidth = 4) {
        ...
        const minRight = Math.min(320, Math.max(240, Math.round(availableWidth * 0.3)));
    ...
    function resetDocOriginalWidth(showMessage = false) {
        ...
        try {
            localStorage.removeItem(DOC_ORIGINAL_WIDTH_KEY);
        } catch (e) {}
        ...
        if (splitHandle && !splitHandle.dataset.bound) {
            ...
            splitHandle.addEventListener("mousedown", (e) => {
                ...
                const onUp = () => {
                    ...
                    try {
                        localStorage.setItem(DOC_ORIGINAL_WIDTH_KEY, String(left.offsetWidth));
                    } catch (e) {}
                };
    ...
    function renderSecurityFileRows(results, reasonKey) {
        return results
            .map((result) => {
                ...
                return `<li class="security-file-row"><span class="security-file-name">${escapeHtml(result.file.name)}</span><span class="security-file-reason">${escapeHtml(reasons.join(" · "))}</span></li>`;
            })
            .join("");
    }
    ...
    async function validateFilesBeforeUpload(inputFiles, uploadHandler) {
        ...
        const { blocked, confidential, safeFiles } = await window.AIOneUploadSecurity.validate(candidateFiles);
    ...
    function addFiles(files) {
        const added = [];
        files.forEach((file) => {
            const type = getUploadFileType(file.name, "file");

            const size = (file.size / 1024 / 1024).toFixed(1) + "MB";
            const fileObj = { name: file.name, type, size, status: null, chunks: 0, uploadOrder: ++uploadSequence };
            ...
            if (!fileDataMap[file.name]) {
                    ...
                    queries: [
                        {
                            ...
                            text: baseName + "와 관련한 세부 추진 현황, 향후 계획, 예산 규모 및 집행 일정에 대한 구체적 답변 요청 (AI 자동 추출)",
                            summary: baseName + "의 추진 현황과 향후 계획, 관련 예산 및 집행 일정에 대한 구체적 답변을 요청하는 AI 자동 추출 질의",
                            type: "single",
                            typeLabel: "단일소관",
                            mainDept: "AI 추천 대기",
                            coopDept: "",
                ...
                docMetaMap[file.name] = {
                    dept: "국회사무처",
                    docType: "질 의 서",
                    docNo: "AI자동-" + Date.now().toString().slice(-6),
                    date: new Date().toISOString().slice(0, 10).replace(/-/g, "."),
                    recipient: "재정경제부 장관",
                    title: baseName + " 관련 질의",
                    intro: ["1. 문서 분석을 통해 아래 사항에 대한 답변을 요청합니다."],
                    closing: "상기 사항에 대한 신속한 확인과 답변을 요청합니다.",
                    signer: "국회사무처장",
                };
            }
        });
    ...
    function getUploadFileType(fileName, fallbackType = "file") {
        ...
        if (["png", "jpg", "jpeg", "gif", "bmp", "webp", "tif", "tiff"].includes(extension)) return "img";
        if (["txt", "md", "rtf"].includes(extension)) return "txt";
        return fallbackType || "file";
    }

    function getUploadFileExtension(fileName, type) {
        const extension = String(fileName || "")
            .split(".")
            .pop()
            .toUpperCase();
    ...
    function renderUploadFileIcon(file) {
        const fileName = file?.displayName || file?.name || "";
        const type = getUploadFileType(fileName, file?.type);
        const extension = getUploadFileExtension(fileName, type);
        const processingClass = ["parsing", "summarizing", "chunking"].includes(file?.status) ? " processing" : "";
        return `<span class="file-type-dot file-type-${type}${processingClass}" aria-hidden="true"></span>
      <span class="file-collapsed-ext-icon file-type-${type}${processingClass}" aria-hidden="true"><span>${escapeHtml(extension)}</span></span>`;
    }

    function updateUploadSummary() {
        const summaryStatus = $("#uploadSummaryStatus");
        const summaryState = $("#uploadSummaryState");
        const summaryFileCount = $("#uploadSummaryFileCount");
        const summaryMemberCount = $("#uploadSummaryMemberCount");
        const collapsedFileCount = $("#uploadSummaryCollapsedFileCount");
        const collapsedMemberCount = $("#uploadSummaryCollapsedMemberCount");
        const collapsedSummary = $("#uploadSummaryCollapsed");
        const currentMemberCount = Number.isFinite(Number(workspaceMemberCount)) ? Number(workspaceMemberCount) : 0;
        const fileTotal = uploadedFiles.length;
        const isWaiting = fileTotal === 0 && currentMemberCount === 0;
        const isMatched = fileTotal === currentMemberCount;
        const difference = Math.abs(fileTotal - currentMemberCount);

        if (summaryFileCount) {
            summaryFileCount.textContent = fileTotal;
            summaryFileCount.classList.toggle("match", isMatched && !isWaiting);
            summaryFileCount.classList.toggle("mismatch", !isMatched);
        }
        if (summaryMemberCount) summaryMemberCount.textContent = currentMemberCount;
        if (summaryState) {
            summaryState.textContent = isWaiting ? "입수 대기" : isMatched ? "파일·의원수 일치" : `${difference}건 차이 확인`;
        }
        if (summaryStatus) {
            summaryStatus.classList.toggle("is-match", isMatched && !isWaiting);
            summaryStatus.classList.toggle("is-mismatch", !isMatched);
            summaryStatus.classList.toggle("is-waiting", isWaiting);
        }
        if (collapsedFileCount) {
            collapsedFileCount.textContent = fileTotal;
            collapsedFileCount.classList.toggle("match", isMatched && !isWaiting);
            collapsedFileCount.classList.toggle("mismatch", !isMatched);
        }
        if (collapsedMemberCount) collapsedMemberCount.textContent = currentMemberCount;
        if (collapsedSummary) {
            collapsedSummary.setAttribute("aria-label", `입수파일수 ${fileTotal}, 의원수 ${currentMemberCount}`);
            collapsedSummary.title = `입수파일수 ${fileTotal} / 의원수 ${currentMemberCount}`;
        }
    }
    ...
    function renderFileList() {
        ...
        const direction = uploadSortOrder === "oldest" ? 1 : -1;
        const sortedFiles = uploadedFiles
            .map((file, index) => ({ file, index, order: Number(file.uploadOrder || index + 1) }))
            .sort((a, b) => Number(Boolean(b.file.pinned)) - Number(Boolean(a.file.pinned)) || direction * (a.order - b.order));
        ...
        fileList.innerHTML = sortedFiles
            .map(
                ({ file: f, index: i, order }) => `
      <li class="${i === activeFileIndex ? "active" : ""}${f.pinned ? " pinned" : ""}" data-file-idx="${i}">
        <button class="file-item-main" type="button" aria-label="업로드 순서 ${order}번, ${escapeHtml(f.displayName || f.name)} 파일 보기">
          <span class="file-upload-order" title="업로드 순서 ${order}번">${order}</span>
          ${renderUploadFileIcon(f)}
          <div class="file-info">
    ...
    function renderFileStatusBadge(f) {
        if (f.status === "parsing") return `<span class="file-status parsing">파싱중</span>`;
        if (f.status === "summarizing") return `<span class="file-status summarizing">SLM 자연어화</span>`;
        if (f.status === "chunking") return `<span class="file-status chunking">청킹중</span>`;
        if (f.status === "chunked") return `<span class="file-status chunked">청킹완료</span>`;
        if (f.status === "done") return `<span class="file-status query-count">질의${getFileQueryCount(f)}건</span>`;
        return `<span class="file-status parsed">대기</span>`;
    }
    ...
    function renderQueryDetailPanel(queries) {
      ...
      <div class="query-detail">
        ...
        <div class="qd-confidence-section">
          <div class="qd-confidence-row progressbar-row">
            <span class="qd-confidence-label progressbar-label">신뢰도</span>
            <div class="progressbar progressbar-lg" data-progressbar data-value="${q.confidence}"
              role="progressbar" aria-label="신뢰도 ${q.confidence}%"
              aria-valuemin="0" aria-valuemax="100" aria-valuenow="${q.confidence}">
              <div class="progressbar-fill"></div>
            </div>
            <span class="qd-confidence-value progressbar-value" data-progressbar-value>${q.confidence}%</span>
          </div>
    ...
    `;
        ...
        if (nextBtn)
            nextBtn.addEventListener("click", () => {
                if (activeQueryIndex < queries.length - 1) {
                    activeQueryIndex++;
                    renderDocContentForFile();
                }
            });
    ...
    function getAIReason(q) {
        const reasons = {
            single: [`"${q.mainDept}" 소관 업무 키워드 매칭 (유사 질의 ${Math.floor(q.confidence * 0.8)}건 분석)`, `과거 답변 이력 기반 "${q.mainDept}" 단일소관 판정`, `질의 내용의 핵심 키워드가 "${q.mainDept}" 업무 범위에 집중`],
            multi: [`"${q.mainDept}" 주관 + "${q.coopDept}" 관련 키워드 동시 감지`, `복수 부서 업무영역에 걸친 복합 질의로 판단 (유사도 ${q.confidence}%)`, `주관 "${q.mainDept}" 확인, 협조 필요 근거: 관련 법령 교차 참조`],
            none: [`본 부처 소관 키워드 미감지. "${q.org}" 소관으로 추정`, `질의 내용이 타 부처 업무영역에 해당 (비소관 판정 신뢰도 ${q.confidence}%)`],
        };
    ...
    function renderQueryList() {
      ...
      <div class="query-card${needsReview ? " needs-review" : ""}" data-qid="${q.id}" data-type="${q.type}">
        ...
        <div class="query-ai-reason">
          <div class="ai-reason-head">
            <span class="ai-reason-icon" aria-hidden="true">
              <svg viewBox="0 0 24 24"><path d="M12 3l1.35 4.15L17.5 8.5l-4.15 1.35L12 14l-1.35-4.15L6.5 8.5l4.15-1.35L12 3z"/><path d="M18.5 13.5l.75 2.25 2.25.75-2.25.75-.75 2.25-.75-2.25-2.25-.75 2.25-.75.75-2.25z"/></svg>
            </span>
            <span class="ai-reason-label">AI 분류 근거</span>
          </div>
          <p class="ai-reason-text">${reason}</p>
        </div>
        <div class="query-confidence-bar progressbar-row">
          <span class="confidence-label progressbar-label">신뢰도</span>
          <div class="progressbar" data-progressbar data-value="${q.confidence}"
            role="progressbar" aria-label="신뢰도 ${q.confidence}%"
            aria-valuemin="0" aria-valuemax="100" aria-valuenow="${q.confidence}">
            <div class="progressbar-fill"></div>
          </div>
          <span class="confidence-value progressbar-value" data-progressbar-value>${q.confidence}%</span>
        </div>
        ${
            q.conflict
                ? `<div class="query-conflict">
          <div class="conflict-head">
            <span class="conflict-dot" aria-hidden="true"></span>
            <strong>룰 충돌</strong>
            <span class="conflict-review-text">검토 필요</span>
          </div>
          <p class="conflict-message">룰 기준 <strong class="conflict-rule-value">${q.conflict.ruleDept}</strong>과 AI 추천 <strong class="conflict-ai-value">${q.conflict.aiDept}</strong>이 다릅니다.</p>
          <span class="conflict-rule-caption">적용 룰: ${q.conflict.ruleLabel}</span>
        </div>`
                : ""
        }
    ...
    const LAYOUT_KEY = "panel-layout-intake-v6";
    const DEFAULT_PANEL_ORDER = ["left", "center", "right"];
    const DEFAULT_PANEL_WIDTHS = { left: 360, right: 400 };
    const PANEL_MIN_WIDTHS = { left: 280, center: 340, right: 300 };
    ...
    function initPanelResize() {
        ...
        container.addEventListener("mousedown", (e) => {
            ...
            const onMouseMove = (ev) => {
                ...
                const boundedDiff = Math.max(-(startWidths[leftIndex] - minWidths[leftIndex]), Math.min(diff, startWidths[rightIndex] - minWidths[rightIndex]));
    ...
    function getSortedSessions() {
        ...
        return [...sessions]
            .filter((session) => !normalizedTerm || [session.title, session.date, session.time, ...(session.files || [])].join(" ").toLowerCase().includes(normalizedTerm))
            .sort((a, b) => {
        ...
        <div class="run-item-actions" aria-label="실행 건 관리">
          <div class="run-action-wrap">
            ...
            <div class="run-action-menu hidden" data-session-menu="${s.id}">
              <button class="run-menu-item" type="button" data-action="pin"><span class="run-menu-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M12 2L12 22M12 2L8 6M12 2L16 6"/></svg></span><span class="run-menu-text">${s.pinned ? "고정 해제" : "고정"}</span></button>
    ...
    `,
                  ...
                  .join("")
            : `<li class="run-empty">${runListSearchTerm ? "검색 결과가 없습니다." : "저장된 실행 건이 없습니다."}</li>`;
    ...
    function toggleSessionPin(sid) {
        ...
        persistSessionPreferences();
        renderDrawer();
        showToast(session.pinned ? "질의분류 목록이 고정되었습니다." : "고정이 해제되었습니다.");
    }
    ...
    function requestSessionDelete(sid) {
        const session = sessions.find((item) => item.id === sid);
        if (!session) return;
        customConfirm("실행 건 삭제", `<strong>${escapeHtml(session.title)}</strong><br>실행 건과 목록 이력을 삭제하시겠습니까?`, () => deleteSession(sid), "danger");
    }
    ...
    function loadSession(sid) {
        ...
        uploadedFiles = session.files.map((name, index) => {
            const type = getUploadFileType(name, "file");
            return { name, type, size: "1.0MB", status: "done", chunks: Math.floor(Math.random() * 10) + 6, uploadOrder: index + 1 };
        });
        uploadSequence = uploadedFiles.length;
    ...
    function requestAiReclassification() {
        ...
        customConfirm("AI 재분류", "AI 재분류를 실행하면 사용자가 수정한 담당실국 및 협조실국이 AI 추천 결과로 다시 변경됩니다.<br>계속하시겠습니까?", executeAiReclassification, "danger");
    }
    ...
    function executeAiReclassification() {
        ...
        setTimeout(() => {
            ...
            if (window.AIOneNotifications) {
                window.AIOneNotifications.notifyLongTask("질의 재분류 완료", "수정된 질의의 담당실국 및 협조실국이 AI 추천 결과로 갱신되었습니다.", "intake");
            }
        }, 1100);
    }
    ...
    function loadNotificationAssignees() {
        ...
        try {
            ...
            notificationDepartmentDirectory.forEach((group) => {
                ...
                const selected = Array.isArray(saved[group.dept]) ? [...new Set(saved[group.dept])].filter((id) => validIds.has(id)) : [];
                notificationDepartmentAssignments[group.dept] = Array.isArray(saved[group.dept]) ? selected : defaults[group.dept];
            });
        } catch (error) {
            notificationDepartmentAssignments = defaults;
        }
    ...
    function getNotificationRoutingForQueries(queries = sampleQueries) {
        ...
        const departments = getNotificationDepartmentsForQueries(sourceQueries).map((dept) => {
            ...
            const selectedIds = Array.isArray(notificationDepartmentAssignments[dept]) ? notificationDepartmentAssignments[dept] : [];
            const recipients = group ? group.staff.filter((person) => selectedIds.includes(person.id)).map((person) => ({ ...person, dept })) : [];
    ...
    function openNotificationAssigneeModal() {
        ...
        const workingAssignments = notificationDepartmentDirectory.reduce((result, group) => {
            ...
            result[group.dept] = Array.isArray(saved) ? [...saved] : group.staff.slice(0, 2).map((person) => person.id);
            return result;
        }, {});
      ...
      <div class="notification-org-layout">
        ...
        <section class="notification-dept-panel">
          <div class="notification-dept-toolbar">
            <label class="drawer-list-search notification-dept-search" for="notificationDeptSearch">
              ...
              <button id="notificationDeptSearchClear" class="drawer-search-clear notification-dept-search-clear hidden" type="button" aria-label="검색어 지우기">×</button>
            </label>
      ...
      <div class="custom-modal-actions notification-modal-actions">
        ...
        const getVisibleDepartments = () => {
            ...
            return notificationDepartmentDirectory.filter((group) => {
                ...
                const searchable = [group.organization, group.dept, ...(group.subunits || []), ...group.staff.flatMap((person) => [person.name, person.position])].join(" ").toLowerCase();
        ...
        const renderOrganizationList = () => {
            if (!orgList) return;
            const specialItems = [{ key: "all", label: "전체 조직", count: notificationDepartmentDirectory.length }];
            const specialHtml = specialItems
                .map((item) => {
          ...
          <span>${escapeHtml(item.label)}</span><strong>${item.count}</strong>
                ...
                .join("");
            const treeHtml = notificationOrganizationOrder
                .map((organization) => {
        ...
        const renderDepartmentSettings = () => {
            ...
            if (deptResult) {
                const organizationLabel =
                    selectedOrganization === "all" ? "전체 조직" : selectedOrganization.startsWith("org:") ? selectedOrganization.slice(4) : selectedOrganization.startsWith("dept:") ? selectedOrganization.slice(5) : selectedOrganization;
          ...
          <div class="notification-dept-staff-list">
            ...
            $$(".notification-dept-staff", grid).forEach((button) => {
                button.addEventListener("click", () => {
                    ...
                    workingAssignments[group.dept] = isSelected ? selectedIds.filter((id) => id !== personId) : [...selectedIds, personId];
        ...
        $("#notificationModalSave")?.addEventListener("click", () => {
            notificationDepartmentAssignments = Object.fromEntries(Object.entries(workingAssignments).map(([dept, ids]) => [dept, [...ids]]));
    ...
    function handleConfirmBtn() {
        ...
        const queryCards = confirmedQueries
            .map((query, index) => {
                ...
                const departmentRows = assignedDepartments
                    .map((item) => {
                        const route = routing.departments.find((entry) => entry.dept === item.dept);
                        const recipients = route?.recipients || [];
                        const recipientNames = recipients.length ? recipients.map((person) => `${person.name} ${person.position}`).join(", ") : "지정된 실국담당자 없음";
    ...
    function updateConfirmBtnUI() {
        ...
        if (aiReclassifyBtn) {
            aiReclassifyBtn.hidden = false;
            aiReclassifyBtn.style.display = "";
            aiReclassifyBtn.classList.remove("hidden");
        }
    ...
    function downloadExcel() {
        ...
        const extractDeadline = (value) => {
            ...
            if (koreanDate) {
                return [koreanDate[1], String(koreanDate[2]).padStart(2, "0"), String(koreanDate[3]).padStart(2, "0")].join(".");
            }
            const dottedDate = text.match(/(\d{4})[.\-/]\s*(\d{1,2})[.\-/]\s*(\d{1,2})/);
            if (dottedDate) {
                return [dottedDate[1], String(dottedDate[2]).padStart(2, "0"), String(dottedDate[3]).padStart(2, "0")].join(".");
            }
            return "";
        };
    ...
    function customConfirm(title, msg, onConfirm, type = "confirm", confirmLabel = "확인") {
        ...
        const confirmIcon = type === "danger" ? "⚠" : '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 11.5 12 4l8 7.5"/><path d="M6 10.5V19h12v-8.5"/><path d="M9 13h6"/><path d="M12 10v6"/></svg>';
    ...
    function showToast(msg) {
        window.AIOneToast.show(msg, { target: toast, duration: 2500 });
    }
